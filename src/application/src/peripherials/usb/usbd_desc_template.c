...
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
#define USBD_VID                      0x7cba
#define USBD_PID                      0xabc  /* Replace '0xaaaa' with your device product ID */
#define USBD_LANGID_STRING            0xbbb   /* Replace '0xbbb' with your device language ID */
#define USBD_MANUFACTURER_STRING      "SEEK" /* Add your manufacturer string */
#define USBD_PRODUCT_HS_STRING        "Sun sensor HS" /* Add your product High Speed string */
#define USBD_PRODUCT_FS_STRING        "Sun sensor FS" /* Add your product Full Speed string */
#define USBD_CONFIGURATION_HS_STRING  "High config" /* Add your configuration High Speed string */
#define USBD_INTERFACE_HS_STRING      "High interface" /* Add your Interface High Speed string */
#define USBD_CONFIGURATION_FS_STRING  "Full config" /* Add your configuration Full Speed string */
#define USBD_INTERFACE_FS_STRING      "Full interface" /* Add your Interface Full Speed string */
